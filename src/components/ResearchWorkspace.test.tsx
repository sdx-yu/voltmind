...
const readiness = { appVersion: '1.5.0', publicRelease: 'NO-GO' as const, engineering: [{ gate: '数据库完整性', status: 'pass' as const, evidence: 'ok' }], external: [{ gate: '真实作者验证', status: 'required' as const, evidence: '至少 5 名完成两周' }] }
