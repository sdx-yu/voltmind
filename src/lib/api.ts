...
export const api = {
  ...
  importResearchCohortPackage: (researchPackage: unknown, input: { evidenceClass: CohortEvidenceClass; segment: CohortSegment; attestation: CohortAttestation; retentionUntil: string }) => request<CohortImportResult>('/api/research-cohort/import', { method: 'POST', body: JSON.stringify({ package: researchPackage, ...input }) }),
