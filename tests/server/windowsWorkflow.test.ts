...
describe('Windows x64 automated desktop delivery', () => {
  ...
  it('locks quality gates, x64 packaging and MSI install/uninstall into the same revision', () => {
    ...
    expect(workflow).toContain("Get-Command 'cscript.exe'")
    expect(workflow).toContain("'bibudai-vbscript-smoke.vbs'")
    expect(workflow).toContain('& $cscript.Source //NoLogo $smokeScript')
